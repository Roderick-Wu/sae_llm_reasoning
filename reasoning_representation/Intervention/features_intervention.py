...
# "OLMo-7B-Instruct" olmo-2-1124-7B-Instruct "OLMo-7B-0724-Instruct-hf" "OLMo-2-1124-7B" The situation with olmo1 is very abnormal, don't know why
...
if not args.Intervention:
    ...
    with open('/home/wuroderi/projects/def-zhijing/wuroderi/Linear_Reasoning_Features/dataset/mmlu-pro-3000samples-responses.json', 'w', encoding='utf-8') as f:
